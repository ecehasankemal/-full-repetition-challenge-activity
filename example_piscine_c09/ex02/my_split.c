...
int
    char_is_separator(char c, char *charset)
{
    int i;
...
int
    count_words(char *str, char *charset)
{
    int i;
    int words;
...
void
    write_word(char *dest, char *from, char *charset)
{
    int i;
...
void
    write_split(char **split, char *str, char *charset)
{
    int i;
    int j;
    int word;
...
char
    **my_split(char *str, char *charset)
{
    char **res;
    int words;
