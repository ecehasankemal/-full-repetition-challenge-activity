    ...
    main(void)
{
    ...
    my_putstr((char *)my_list_at(list, 1).data);
    my_putchar('\n');

    my_putstr("Last element: ");
    my_putstr((char *)my_list_at(list, 2).data);
    my_putchar('\n');

    my_putstr("Out of bounds: ");
    my_putstr((char *)my_list_at(list, 0).data);
    my_putchar('\n');
